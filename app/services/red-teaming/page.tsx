...
const phases = [
  ...
  },
  {
    ...
    desc: "Completing the defined objectives: data access, system control, or infrastructure compromise.",
    icon: Target,
    activities: [
...
const complianceCoverage = [
  ...
  { name: "MITRE Engage", desc: "Adversary engagement methodology" },
];
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <Container>
          <div className="py-10 sm:py-14 md:py-20">
            <Breadcrumbs items={[{ label: "Services", href: "/services" }, { label: "Red Teaming" }]} />
            ...
            >
              <Target className="h-3 w-3 sm:h-4 sm:w-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent" />
              Pinpoint - Red Teaming
            </motion.p>
            ...
            >
              Think Like an{" "}
              <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Advanced Attacker</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
                ...
                <div className="mt-6 sm:mt-8 space-y-3">
                  {complianceCoverage.map((item, i) => (
                    <motion.div
                      ...
                      className="flex items-center gap-4 rounded-xl bg-white/5 p-4"
                    >
                      <ShieldCheck className="h-5 w-5 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent shrink-0" />
                      <div>
          ...
          <div className="py-10 sm:py-16">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {tools.map((tool, i) => (
                ...
                >
                  <Target className="h-4 w-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent shrink-0" />
