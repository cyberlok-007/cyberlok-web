...
const phases = [
  {
    ...
    activities: [
      ...
      "S3/Azure Blob/S3 bucket discovery",
...
const cloudPlatforms = [
  { name: "Amazon Web Services", icon: Cloud, desc: "EC2, S3, IAM, Lambda, VPC, EKS" },
  { name: "Microsoft Azure", icon: Cloud, desc: "VMs, Blob Storage, AAD, Functions, AKS" },
  { name: "Google Cloud Platform", icon: Cloud, desc: "GCE, GCS, IAM, Cloud Functions, GKE" },
  { name: "Multi-Cloud", icon: Globe, desc: "Combined AWS, Azure, and GCP environments" },
];
...
export default function CloudSecurityTestingPage() {
  return (
    <div>
      {/* HERO */}
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <Container>
          <div className="px-2 py-10 sm:py-14 md:py-20">
            <Breadcrumbs items={[{ label: "Services", href: "/services" }, { label: "Offensive Security", href: "/services/offensive-security" }, { label: "Cloud Security Testing" }]} />
            ...
            >
              Cyberlok&apos;s cloud security testing covers AWS, Azure, and GCP environments. We identify misconfigurations,
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="mt-2 sm:mt-3 max-w-2xl text-sm sm:text-base text-white/65 leading-relaxed">
                    Get comprehensive cloud security testing from Cyberlok. Identify misconfigurations and data exposure risks.
                  </p>
                </div>
                <Link
                  href="/contact"
