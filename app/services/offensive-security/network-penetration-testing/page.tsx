      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <Container>
          <div className="px-2 py-10 sm:py-14 md:py-20">
            ...
            >
              <Network className="h-3 w-3 sm:h-4 sm:w-4 text-cyan-300" />
            ...
            >
              Test Your Network{" "}
              <span className="text-cyan-300">From an Attacker&apos;s Perspective</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="mt-6 sm:mt-8 space-y-3">
                  {scopeTypes.map((type, i) => (
                    ...
                    >
                      <Network className="h-5 w-5 text-cyan-400 shrink-0" />
                      <div>
