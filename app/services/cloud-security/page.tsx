      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <Container>
          <div className="py-10 sm:py-14 md:py-20">
            ...
            >
              <Cloud className="h-3 w-3 sm:h-4 sm:w-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent" />
            ...
            >
              Secure Your{" "}
              <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Cloud Infrastructure</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="mt-6 sm:mt-8 space-y-3">
                  {cloudPlatforms.map((platform, i) => (
                    ...
                    >
                      <Cloud className="h-5 w-5 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent shrink-0" />
                      <div>
          ...
          <div className="py-10 sm:py-16">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {tools.map((tool, i) => (
                ...
                >
                  <Cloud className="h-4 w-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent shrink-0" />
