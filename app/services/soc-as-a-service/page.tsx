        ...
        <Container>
          <div className="px-2 py-10 sm:py-14 md:py-20">
            <p className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 sm:px-4 py-2 text-xs sm:text-sm text-white/70">
              <Radar className="h-3 w-3 sm:h-4 sm:w-4 text-cyan-300" /> SOC-as-a-Service
            </p>
            <h1 className="mt-4 sm:mt-6 text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight leading-tight">
              Enterprise Security Operations{" "}
              <span className="text-cyan-300">Without the Overhead</span>
            </h1>
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
              {tiers.map((tier) => (
                ...
                >
                  ...
                  <p className="mt-3 text-xs text-cyan-400">{tier.endpoints}</p>
                  <p className="mt-2 sm:mt-3 text-cyan-300 font-semibold text-sm sm:text-base">{tier.price}</p>
