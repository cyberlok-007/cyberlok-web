      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <Container>
          <div className="py-10 sm:py-14 md:py-20">
            ...
            >
              <Lock className="h-3 w-3 sm:h-4 sm:w-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent" />
            ...
            >
              Build Security Into{" "}
              <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Your Development Process</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="py-10 sm:py-16">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {practices.map((practice, i) => (
                ...
                >
                  <practice.icon className="h-8 w-8 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-4" />
              ...
              >
                ...
                <div className="mt-6 sm:mt-8 space-y-3">
                  {sdlcPhases.map((phase, i) => (
                    ...
                    >
                      <Lock className="h-5 w-5 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent shrink-0" />
                      <div>
              ...
              >
                ...
                <div className="mt-6 sm:mt-8 space-y-3">
                  {tools.map((tool, i) => (
                    ...
                    >
                      <Code2 className="h-4 w-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent shrink-0" />
